...
// OpenGL-MFCDlg.cpp : 实现文件
//

#include "stdafx.h"
#include "OpenGL-MFC.h"
#include "OpenGL-MFCDlg.h"
...
COpenGLMFCDlg::COpenGLMFCDlg(CWnd* pParent /*=NULL*/): CDialogEx(COpenGLMFCDlg::IDD, pParent){
...
BEGIN_MESSAGE_MAP(COpenGLMFCDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
